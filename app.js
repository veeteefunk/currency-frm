...
btn.addEventListener("click", ()=> {
    ...
    rupees.innerHTML = `<span>Indian Rupees:</span>
    ${formatter1.format(amount)}`;
    dollars.innerHTML = `<span>US Dollars:</span>
    ${formatter2.format(amount)}`;
    yen.innerHTML = `<span>Japanese Yen:</span>
    ${formatter3.format(amount)}`;
